...
new vue_1.default({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, shared_1.client.post(new dtos_1.UpdateContact(__assign(__assign({}, request), { id: this.id })))];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3: return [4 /*yield*/, shared_1.client.post(new dtos_1.CreateContact(__assign(__assign({}, request), { agree: this.agree })))];
                        case 4:
                            _a.sent();
                            _a.label = 5;
                        case 5:
    ...
    mounted: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        qs = (0, client_1.queryString)(location.href);
    ...
    data: function () { return (__assign(__assign({ loading: false, valid: true, update: false }, DATA), { id: 0, title: "", name: "", color: "", filmGenres: [], age: 13, agree: false, nameRules: shared_1.nameRules, responseStatus: null })); },
});
